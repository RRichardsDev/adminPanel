                        ...
                        <tbody>
                             ...
                             @foreach($users as $user)
                                ...
                                <th class="text-justify-centre align-middle nr" scope="row">{{$user->id}}</th>
                                    <td class="text-justify-centre align-middle confname">{{$user->name}}</td>
                                    <td class="text-justify-centre align-middle">{{$user->email}}</td>      
                                    <td class="text-justify-centre align-middle">{{$user->phone}}</td>          
                                    <td class="text-justify-centre align-middle">Manager</td>
                                    <td class="text-justify-centre align-middle">
                                        <a href="{{route('editUser', $user->id)}}">
                                            <button class="btn btn-outline-info" name="edit">Editt</button>
                                        </a>
                                    </td>
